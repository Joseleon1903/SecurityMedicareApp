...
CREATE UNIQUE INDEX ENTIDAD_IDX ON ENTIDAD(ENTIDAD_ID) ;
CREATE INDEX ENTIDAD_TIPO_ENTIDAD_IDX ON ENTIDAD(TIPO_ENTIDAD_ID) ;
CREATE INDEX ENTIDAD_REGIMEN_IDX ON ENTIDAD(REGIMEN_ID) ;
