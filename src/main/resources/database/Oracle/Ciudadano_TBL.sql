...
CREATE UNIQUE INDEX CIUDADANO_IDX ON CIUDADANO(CIUDADANO_ID) TABLESPACE SIGMA_INDEX;
CREATE UNIQUE INDEX CIUDADANO_NSS_IDX ON CIUDADANO(NSS) TABLESPACE SIGMA_INDEX;
CREATE INDEX CIUDADANO_CEDULA_IDX ON CIUDADANO(CEDULA) TABLESPACE SIGMA_INDEX;
CREATE INDEX CIUDADANO_MUNICIPIO_IDX ON CIUDADANO(MUNICIPIO_ID) TABLESPACE SIGMA_INDEX;
CREATE INDEX CIUDADANO_NACIONALIDAD_IDX ON CIUDADANO(NACIONALIDAD_ID) TABLESPACE SIGMA_INDEX;
CREATE INDEX CIUDADANO_ACTA_NACIMIENTO_IDX ON CIUDADANO(MUNICIPIO_ACTA, OFICIALIA_ACTA, LIBRO_ACTA, FOLIO_ACTA, NUMERO_ACTA, ANIO_ACTA, LITERAL_ACTA, TIPO_LIBRO_ACTA) TABLESPACE SIGMA_INDEX;
CREATE INDEX CIUDADANO_MOTIVO_CANC_IDX ON CIUDADANO(MOTIVO_CANCELACION_ID) TABLESPACE SIGMA_INDEX;
CREATE INDEX CIUDADANO_FEC_NOT_FALLEC_IDX ON CIUDADANO(FECHA_NOT_FALLECIMIENTO) TABLESPACE SIGMA_INDEX;
CREATE INDEX CIUDADANO_FEC_ULTIMO_CMB_IDX ON CIUDADANO(FECHA_ULTIMO_CAMBIO) TABLESPACE SIGMA_INDEX;
