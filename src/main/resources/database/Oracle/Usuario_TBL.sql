...
CREATE UNIQUE INDEX USUARIO_IDX ON USUARIO(USUARIO_ID) ;
CREATE INDEX USUARIO_CODIGO_IDX ON USUARIO(CODIGO) ;
CREATE INDEX USUARIO_CONTACTO_IDX ON USUARIO(CONTACTO_ID) ;
CREATE INDEX USUARIO_TIPO_USUARIO_IDX ON USUARIO(TIPO_USUARIO_ID) ;
CREATE INDEX USUARIO_USUARIO_ULT_CAMB_IDX ON USUARIO(USUARIO_ULTIMO_CAMBIO_ID) ;
