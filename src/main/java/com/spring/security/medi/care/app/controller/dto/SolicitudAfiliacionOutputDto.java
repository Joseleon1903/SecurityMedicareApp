...
public class SolicitudAfiliacionOutputDto implements Serializable{
    ...
    public SolicitudAfiliacionOutputDto(Long solicitudId, Integer servicioId, Integer loteId, Long seguroId, Long regimenId, String tipoAfiliado, String cedula, String nss, String cedulaTitular, Long entidadId, Boolean automatica, String estado, Date fechaRecepcion, Long municipioId) {
    ...
    public SolicitudAfiliacionOutputDto(SolicitudAfiliacion solicitud) {
        ...
        this.seguroId = solicitud.getSeguroId();
        this.regimenId = solicitud.getRegimenId();
        this.tipoAfiliado = solicitud.getTipoAfiliado();
